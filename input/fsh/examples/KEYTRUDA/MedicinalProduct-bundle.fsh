...
* entry[+]
  * insert bundleEntry(RegulatedAuthorization, MA-6623101)
* entry[+]
  * insert bundleEntry(PackagedProductDefinition, PMP-Keytruda-100mg-4ml-Solution-for-Infusion)
* entry[+]
  * insert bundleEntry(RegulatedAuthorization, MA-66231001)
* entry[+]
  * insert bundleEntry(RegulatedAuthorization, FOPH-20416)
* entry[+]
...
* entry[+]
  * insert bundleEntry(ClinicalUseDefinition, LIM-20416.XX)