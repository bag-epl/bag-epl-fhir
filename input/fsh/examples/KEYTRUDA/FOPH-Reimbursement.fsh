...
* extension.extension[=].extension[=].valueMoney.value = 4407.68
...
* extension.extension[=].extension[=].valueDate = "2023-01-01"

* extension.extension[+].url = "http://fhir.ch/ig/ch-epl/StructureDefinition/productPrice"
* extension.extension[=].extension[+].url = "value"
* extension.extension[=].extension[=].valueMoney.value = 4768.50
* extension.extension[=].extension[=].valueMoney.currency = #CHF
* extension.extension[=].extension[+].url = "type"
...
* indication[=].extension[=].extension[=].valueDate = "2025-11-01" // Limitation Status Date
* indication[=].extension[=].extension[+].url = "period"
* indication[=].extension[=].extension[=].valuePeriod.start = "2025-11-01" // Limitation Period Start Date
...
* indication[=].extension[=].extension[+].url = "indicationCode"
* indication[=].extension[=].extension[=].valueString = "20416.XX" // Indication Code

// Limitation Reference
* indication[=].extension[=].extension[+].url = "limitationIndication"
* indication[=].extension[=].extension[=].valueReference = Reference(LIM-20416.XX)
...
* indication[=].extension[=].extension[=].extension[=].valueCodeableConcept = ChEplTypeOfPriceChangeCS#756002006009 "Normal price mutation"
...
// Indication Reference
// No indication referenced, as the limitation is valid for the medicinal product and not for a specific indication
