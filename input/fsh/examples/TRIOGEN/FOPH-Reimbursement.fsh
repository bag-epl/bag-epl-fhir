...
* subject = Reference(PMP-Triogen-250mg-Capsule)
...
* extension.extension[=].valueIdentifier.value = "21070" // FOPH Dossier Number 
...
* extension.extension[=].valueDate = "2020-09-01" // Reimbursement Start
...
* extension.extension[=].valuePeriod.start = "2020-09-01" // Listing Period Start
* extension.extension[+].url = "firstListingDate"
* extension.extension[=].valueDate = "2020-09-01" // Date of First Listing
...
* extension.extension[=].extension[=].valueMoney.value = 4117.12
...
* extension.extension[=].extension[=].valueCodeableConcept = ChEplTypeOfPriceChangeCS#756002006010 "Price mutation at first listing"
* extension.extension[=].extension[+].url = "changeDate"
* extension.extension[=].extension[=].valueDate = "2020-09-01"

* extension.extension[+].url = "http://fhir.ch/ig/ch-epl/StructureDefinition/productPrice"
* extension.extension[=].extension[+].url = "value"
* extension.extension[=].extension[=].valueMoney.value = 4470.40
* extension.extension[=].extension[=].valueMoney.currency = #CHF
* extension.extension[=].extension[+].url = "type"
...
* indication.extension[=].extension[=].valueDate = "2020-09-01" // Limitation Status Date
* indication.extension[=].extension[+].url = "period"
* indication.extension[=].extension[=].valuePeriod.start = "2020-09-01" // Limitation Period Start Date
...
* indication.extension[=].extension[=].extension[=].valueMoney.value = 4117.12
...
* indication.extension[=].extension[=].extension[=].valueDate = "2020-09-01"

* indication.extension[=].extension[+].url = "http://fhir.ch/ig/ch-epl/StructureDefinition/productPrice"
* indication.extension[=].extension[=].extension[+].url = "value"
* indication.extension[=].extension[=].extension[=].valueMoney.value = 4470.40
* indication.extension[=].extension[=].extension[=].valueMoney.currency = #CHF
* indication.extension[=].extension[=].extension[+].url = "type"
