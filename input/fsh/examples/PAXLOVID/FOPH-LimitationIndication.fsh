...
* type = #indication
* indication.diseaseSymptomProcedure.concept = $sct-ch-full#840539006 "Disease caused by severe acute respiratory syndrome coronavirus 2 (disorder)" // Limitation as Disease Symptom Procedure
