Instance: PhP-Nirmatrelvir-150mg-Filmcoatedtablet
InstanceOf: CHIDMPAdministrableProductDefinition
Usage: #example
Title: "PhP-Nirmatrelvir-150mg-Filmcoatedtablet"
...
* status = #active
* formOf = Reference(Paxlovid-Filmcoatedtablet) // Link to Medicinal Product
...
Instance: PhP-Ritonavirum-100mg-Filmcoatedtablet
InstanceOf: CHIDMPAdministrableProductDefinition
Usage: #example
Title: "PhP-Ritonavirum-100mg-Filmcoatedtablet"
Description: "Administrable Product of Paxlovid-Filmcoatedtablet"
