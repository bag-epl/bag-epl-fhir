...
* extension.extension[=].extension[=].valueMoney.value = 958.62
...
* extension.extension[+].url = "http://fhir.ch/ig/ch-epl/StructureDefinition/productPrice"
* extension.extension[=].extension[+].url = "value"
* extension.extension[=].extension[=].valueMoney.value = 1113.95
* extension.extension[=].extension[=].valueMoney.currency = #CHF
* extension.extension[=].extension[+].url = "type"
...
* indication.extension[=].extension[=].valueString = "Befristete Limitation bis 31.12.2025. PAXLOVID wird als antivirale Monotherapie für die Behandlung einer bestätigten Covid-19 Infektion (Positiver Erregernachweis Antigen/PCR und vorhandener Covid-19-Symptome) in folgenden Fällen vergütet:
